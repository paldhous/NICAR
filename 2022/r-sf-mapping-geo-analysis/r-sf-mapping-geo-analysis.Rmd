...
Notice also that the `st_as_sf` function includes `crs = st_crs(4326)`. This sets the projection, or [coordinate reference system](https://en.wikipedia.org/wiki/Spatial_reference_system), for the geometry.
